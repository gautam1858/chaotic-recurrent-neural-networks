...
tf.flags.DEFINE_string("eval_filepath", "v.txt0", "Evaluate on this data (Default: None)")
tf.flags.DEFINE_string("vocab_filepath", "runs/1498731951/checkpoints/vocab", "Load training time vocabulary (Default: None)")
tf.flags.DEFINE_string("model", "runs/1498731951/checkpoints/model-123000", "Load trained model checkpoint (Default: None)")
